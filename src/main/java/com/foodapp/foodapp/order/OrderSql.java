...
public class OrderSql {
    ...
    public static final String BASE_QUERY = "SELECT o FROM Order o WHERE o.company.id = :" + COMPANY_ID_PARAM;
    public static final String BASE_SORT_QUERY = " ORDER BY";
    public static final String BASE_COUNT_QUERY = "SELECT COUNT(o) FROM Order o WHERE o.company.id = :" + COMPANY_ID_PARAM;
