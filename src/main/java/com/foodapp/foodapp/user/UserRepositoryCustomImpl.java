...
public class UserRepositoryCustomImpl implements UserRepositoryCustom {
    ...
    public UsersPagedResult searchOrders(UsersSearchParams params) {
        ...
        valueParamsMap.put(UserSql.DATE_TO_PARAM, params.getDateTo() != null ? params.getDateTo().atTime(23, 59) : null);
        ...
        // Fetch the orders
        List<User> orders = userQuery.getResultList();

        // Fetch the total count
        long totalCount = (long) countQuery.getSingleResult();

        return UsersPagedResult.builder()
                .users(UserMapper.toUsersDto(orders))
